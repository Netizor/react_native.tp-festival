...
const ProgrammationListItemComponent = ({
	...
	return (
		<View style={styles.container}>
			...
			<TouchableWithoutFeedback
				onPress={() => programme.artist && programme.artist.slug ? router.push(`/artist/${programme.artist.slug}`) : null}
			>
				<View style={styles.innerContainer}>
					{programme.artist && programme.artist.poster ? (
						<Image
					...
					{artist && artist.music_type ? (
						...
						<View style={styles.musicTypeContainer}>
							<Ionicons name="pricetag-outline" />
							<Text style={styles.musicType}>Genre inconnu</Text>
						</View>
					)}
					{programme.day && programme.day.date ? (
						...
						<View style={styles.dateContainer}>
							<Feather name="calendar" />
							<Text style={styles.date}>Date inconnue</Text>
						</View>
					)}
				</View>
			</TouchableWithoutFeedback>
